...
import dagohoy1 from "../assets/dagohoy/dagohoy (1).jpg";
import dagohoy2 from "../assets/dagohoy/dagohoy (2).jpg";
import dagohoy3 from "../assets/dagohoy/dagohoy (3).jpg";
